...
files <- list.files(path = "/Volumes/cvmbs/RSTOR-HenaO_lab/SolaVAX-TB/SvX_R_analysis/D30 spleen", pattern = "*.csv", full.names = TRUE)
...
Df1 <- Df1 %>%
  filter(group %in% c("Saline", "BCG", "BCG BCG", "SvX IM + CpG"))
...
colnames(Df1)
Bcells <- pivot_longer(data = Df1, cols = "CD3-  B220-  CD19+ ":"CD3-  B220-  CD19- ", names_to = "cell_types", values_to = "cell_type_count")
