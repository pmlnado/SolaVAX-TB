...
files <- list.files(path = "/Volumes/cvmbs/RSTOR-HenaO_lab/SolaVAX-TB/SvX_R_analysis/NO_AF_D90_All_Groups", pattern = "*.csv", full.names = TRUE)
...
cd4 <- cd4 %>%
 ...
 cd4 %>%
  ...
  facet_wrap(~ cell_types, scale = "free_y", ncol = 3, nrow = 8) +
  ...
  geom_point(size = 3, shape = 21, alpha = 0.8, na.rm = TRUE, color = "black",
    ...
    labs(title = "CD4+ Tcells in Lung Day 90", x = "Group", y = "Proportion of Live", color = "Vaccine") +
...
NK <- NK %>%
 ...
 NK %>%
  ...
  geom_point(size = 3, shape = 21, alpha = 0.8, na.rm = TRUE, color = "black",
             position = position_dodge(width = 0.75)) +
    labs(title = "NK cells in Lung Day 90", x = "Group", y = "Proportion of Live", color = "Vaccine") +
  guides(fill = "none", shape = guide_legend(title = "Vaccine")) +
  theme_bw() + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        strip.text = element_text(size = 10, face = "bold"))
...
Bcells %>%
  ...
  geom_point(size = 3, shape = 21, alpha = 0.8, na.rm = TRUE, color = "black",
             position = position_dodge(width = 0.75)) +
    labs(title = "B cells in Lung Day 90", x = "Group", y = "Proportion of Live", color = "Vaccine") +
  guides(fill = "none", shape = guide_legend(title = "Vaccine")) +
  theme_bw() + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        strip.text = element_text(size = 10, face = "bold"))
